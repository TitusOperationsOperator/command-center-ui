  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full border border-neon/30 bg-space-card/90 backdrop-blur-xl shadow-lg shadow-neon/10 md:hidden"
      >
